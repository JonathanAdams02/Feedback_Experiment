  ...
  const instructions = {
    ...
    stimulus: `
      <div class="instructions">
        ...
        <p style="font-size: 24px;">Please pay close attention to which shapes you see, at the end of the experiment you will be asked which shape you saw the most.</p>
